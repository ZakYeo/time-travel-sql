...
The CLI uses Node's built-in argument parser and internal MIT packages for SDK
contracts, local storage, portable exchange and historical queries. The query
adapter brings shared SQL/PGlite dependencies described below. No external runtime dependency
